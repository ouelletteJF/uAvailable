 ...
 * @author Usager
 */
public class BlocDisponilites {
    
   private String nomBloc ,descriptionBloc,dateHeureBloc,duree,nomCalendrier,optRappelBloc;
    ...
    public String getDateHeureBloc() {
    ...
    public void setDateHeureBloc(String dateHeureBloc) {
